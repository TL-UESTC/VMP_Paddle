...
_C.lr2 = 7e-5
_C.learn_dims = 'one'
_C.forward_type = 'bayesian' #bayesian
...
def load_cfg_fom_args(description="Config options."):
    ...
    parser.add_argument("--cfg", dest="cfg_file", type=str, default='./cfgs/mop.yaml', 
    ...
    paddle.seed(cfg.RNG_SEED)
    random.seed(cfg.RNG_SEED)
    # torch.backends.cudnn.benchmark = cfg.CUDNN.BENCHMARK
    # paddle.backends.cudnn.benchmark = cfg.CUDNN.BENCHMARK

    logger = logging.getLogger(__name__)
    # version = [torch.__version__, torch.version.cuda,
    #            torch.backends.cudnn.version()]
    version = [paddle.__version__, paddle.version.cuda,0]
            #    paddle.backends.cudnn.version()]
    # logger.info("PyTorch Version: torch={}, cuda={}, cudnn={}".format(*version))
    print("PyTorch Version: torch={}, cuda={}, cudnn={}".format(*version))
    # logger.info(cfg)
    pprint.pprint(cfg)
